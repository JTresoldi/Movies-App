...
class MovieListPolicy
{
     ...
     */
    public function view(User $user, MovieList $list): bool
    {
     ...
     */
    public function update(User $user, MovieList $list): bool
    {
        return $list->user_id === $user->id;
    }
     ...
     */
    public function delete(User $user, MovieList $list): bool
    {
        return $list->user_id === $user->id;
    }
